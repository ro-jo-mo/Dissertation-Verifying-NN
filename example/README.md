...
```bash
vehicle verify \
  --specification example/mnist-robustness.vcl \
  --network classifier:example/mnist-classifier.onnx \
  --parameter epsilon:0.005 \
  --dataset trainingImages:example/t2-images.idx \
  --dataset trainingLabels:example/t2-labels.idx \
  --verifier Marabou
```
